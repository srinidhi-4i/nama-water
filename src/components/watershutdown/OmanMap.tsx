...
const OMAN_REGIONS = [
    ...
    },
    {
        ...
        path: "M924.7 489.1l3.4 8.8 0.5 1.9 1 2.7 2.3 1.8 4.6 2.6 5 8.1 0.7 2.2 1.7 2.1 5.4 5 3.9 2.1-6.9 7.4 0.2 6.7 2.4 7.3-1.2 18.3-6.2 16.5-15.6 8.4-27.5 15-58.1 21.2-64.9 23.7-31.5-111.3 12.5-26.3 29.1-23 7.8-0.9 21.1-13.7 19.2-4.8 38.1 25.9 41.7 5.6 8.4-9.3 2.9-4z",
    },
    {
        id: "OMN5497",
        name: "Al Batinah South",
        path: "M781.1 375.3l-0.5 1.1 0.2 0.4-4.1 19.7 3.3 13.6-27.7 23-3.8 8.5-32.5 5.4-4.9-2.4-14.6-1.7-37.6-38.5 15.6-5.2 16.4-14 14.8-25.9 6.8 3 7.5 2.4 5.2 1 2.9 0.1 8.6-0.5 2.4 0.5 3.6 4.8 1.3 1.1 3.1 0.8 3.6 1.8 3.2 0.4 16.5-0.9 5.6 0.4 5.1 1.1z",
    },
]

export function OmanMap({ selectedPlaces = [], width = "100%", height = "100%", className = "" }: OmanMapProps) {
    return (
                ...
                {OMAN_REGIONS.map((region) => (
                    <path
                        ...
                        className={`transition-colors duration-300 ${
                            selectedPlaces.includes(region.id) ? "fill-[#d00]" : "fill-[#e9fbfc]"
                        }`}
                    >
