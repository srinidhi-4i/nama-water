...
export default function AccountDashboard({ accountNumber }: AccountDashboardProps) {
  ...
  useEffect(() => {
    const initDashboard = async () => {
      setIsLoading(true)
      try {
        // First get basic customer info if not in session, or just fetch fresh
        // The previous page.tsx used 'branchAccountData' from session storage
        // To be truly dynamic and support refreshes/direct links, we should fetch what we need
  ...
  if (!accountData) {
    return <div className="p-8 text-center text-red-500">Account not found or session expired.</div>
  }
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <PageHeader 
        language={language}
        titleEn="Account Dashboard"
        titleAr="لوحة تحكم الحساب"
        breadcrumbItems={[
            ...
            <div className="grid grid-cols-12 gap-4">
                ...
                <div className="col-span-12 lg:col-span-9 space-y-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                        <Card className="col-span-7 lg:col-span-3 p-6">
                        ...
                        <Card className="col-span-7 lg:col-span-4 p-6">
                            <div className="flex justify-between items-center mb-4">
